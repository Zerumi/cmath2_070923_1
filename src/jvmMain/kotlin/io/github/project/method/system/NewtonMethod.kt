...
class NewtonMethod : ISystemSolvingMethod {
    ...
    override fun solveSystem(equationSystemParams: EquationSystemParams): EquationSystemResult {
        ...
        while (flag) {
            ...
            if (solution.status != SLAESolutionStatus.OK) throw NoRootException()
        ...
        return EquationSystemResult.ok(EquationSystemSolvingMethod.NEWTON_METHOD,
            result.map { it.value }.toList(), iterations, emptyList()) // todo
    }
}